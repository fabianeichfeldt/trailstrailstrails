...
// commentsHTML() and its helpers were removed here — superseded by the
...
// migration, Phase 2 (see docs/superpowers/specs/2026-08-13-spot-panel-vue-migration-design.md).
