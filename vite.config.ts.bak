  ...
  build: {
    rollupOptions: {
      input: {
        ...
        trailradar_vs_trailforks: resolve(__dirname, "trailradar-vs-trailforks.html"),
        trailradar_vs_komoot: resolve(__dirname, "trailradar-vs-komoot.html"),
        ...
        spot_manager: resolve(__dirname, "spotmanager.html"),
      }
    }
  }
});
